...
exports.vehiclesInfoResponseObject = ( gmResData ) => {
  gmResData = mockSmartcarResponses(gmResData, mockSmartcarResponses.vehiclesInfo)
...
exports.doorSecResponseObject = ( gmResData ) => {
  gmResData = mockSmartcarResponses(gmResData, mockSmartcarResponses.securityObject)
...
exports.energyRangeObject = ( gmResData, energyType ) => {
  gmResData = mockSmartcarResponses(gmResData, mockSmartcarResponses.fuelBatteryObject)
  ...
  let energyLevelData = {}
  energyLevelData.percentage = parseInt( gmResData[gmActionType].value )
...
exports.engineActionResponseObject = ( gmResData ) => {
  gmResData = mockSmartcarResponses(gmResData, mockSmartcarResponses.actionEngineObject)
